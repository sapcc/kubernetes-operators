...
type Clientset struct {
	*discovery.DiscoveryClient
	openstackV1 *openstackv1.OpenstackV1Client
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.openstackV1, err = openstackv1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.openstackV1 = openstackv1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.openstackV1 = openstackv1.New(c)
