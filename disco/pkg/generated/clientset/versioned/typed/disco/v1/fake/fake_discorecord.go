...
func (c *FakeDiscoRecords) Get(name string, options v1.GetOptions) (result *discov1.DiscoRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(discorecordsResource, c.ns, name), &discov1.DiscoRecord{})

	if obj == nil {
		return nil, err
	}
	return obj.(*discov1.DiscoRecord), err
}

// List takes label and field selectors, and returns the list of DiscoRecords that match those selectors.
func (c *FakeDiscoRecords) List(opts v1.ListOptions) (result *discov1.DiscoRecordList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(discorecordsResource, discorecordsKind, c.ns, opts), &discov1.DiscoRecordList{})
	...
	list := &discov1.DiscoRecordList{ListMeta: obj.(*discov1.DiscoRecordList).ListMeta}
	for _, item := range obj.(*discov1.DiscoRecordList).Items {
...
func (c *FakeDiscoRecords) Create(discoRecord *discov1.DiscoRecord) (result *discov1.DiscoRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(discorecordsResource, c.ns, discoRecord), &discov1.DiscoRecord{})
...
func (c *FakeDiscoRecords) Update(discoRecord *discov1.DiscoRecord) (result *discov1.DiscoRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(discorecordsResource, c.ns, discoRecord), &discov1.DiscoRecord{})
...
func (c *FakeDiscoRecords) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(discorecordsResource, c.ns, name), &discov1.DiscoRecord{})
...
func (c *FakeDiscoRecords) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &discov1.DiscoRecordList{})
	return err
}

// Patch applies the patch and returns the patched discoRecord.
func (c *FakeDiscoRecords) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *discov1.DiscoRecord, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(discorecordsResource, c.ns, name, pt, data, subresources...), &discov1.DiscoRecord{})
