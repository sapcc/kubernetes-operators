...
replace (
	github.com/ant31/crd-validation => github.com/jeromefroe/crd-validation v0.0.0-20211020211201-e17083648306
	github.com/googleapis/gnostic v0.5.5 => github.com/google/gnostic v0.6.9
	github.com/googleapis/gnostic v0.5.7-v3refs => github.com/google/gnostic v0.6.9
)
