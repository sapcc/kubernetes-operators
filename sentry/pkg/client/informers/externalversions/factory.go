...
import (
	...
	sentry "github.com/sapcc/kubernetes-operators/sentry/pkg/client/informers/externalversions/sentry"
...
func (f *sharedInformerFactory) Sentry() sentry.Interface {
	return sentry.New(f, f.namespace, f.tweakListOptions)
}
